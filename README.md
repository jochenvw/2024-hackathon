...
| ARM_creator       | Expert on ARM specifications and generates ARM template to enable service property    | [src](./src/lmgtfu-agent/agents/get_arm_spec.py)      |  ![](./assets/arm.png) |
